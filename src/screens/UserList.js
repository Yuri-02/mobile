...
const users = [
    ...
    {id: '4', photo1:'https://vipcheck.wageindicator.org/media/416px-Gal_Gadot_cropped_lighting_corrected_2b.jpg', name: 'Veronica Ramos', city:'Petrópolis', state:'RJ', maritalStatus: 'Em um relacionamento sério', aboutMe: 'Moro em Petrópolis e trabalho como analista de planejamento em uma empresa de óptica. Minha jornada começou em uma pequena cidade, onde desenvolvi um amor pela organização e pela análise de dados. Esse interesse me levou a cursar administração de empresas, com especialização em planejamento estratégico.', photo2:'https://amazonasatual.com.br/wp-content/uploads/2019/12/gal-gadot.jpg'}
]
